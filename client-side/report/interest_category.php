<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/report/interest_category.action.php";	//server side folder url
		...
		function LoadTable(start, end){
			...
			GetDataTable(tName, aJaxURL, "get_list", 3, "start=" + start + "&end=" + end, 0, "", 0, "desc");
		}
...
<body>
    <div id="dt_example" class="ex_highlight_row">
        <div id="container" style="width: 90%;">        	
            <div id="dynamic">
            	<h2 align="center">აბონენტთა ინტერესი ობიექტთა კატეგორიების მიხედვით</h2>
            	<div id="button_area">
