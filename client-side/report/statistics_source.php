...
var s_i 		= 0;
var done 	= ['','','','','','',''];
var aJaxURL	= "server-side/report/statistics_soure.action.php";		//server side folder url
var tName   = "report";
...
function drawFirstLevel(){
		...
		var start	= $("#search_start").val();
		var end		= $("#search_end").val();
		var d_url   ="&start="+start+"&end="+end+"&done="+s_i+"&production_category_id="+done[0]+"&type="+done[1]+"&category="+done[2]+"&sub_category="+done[3];
