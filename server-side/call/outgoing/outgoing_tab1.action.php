			...
			$data .='
		        ...
		        <div style="width:356px;" id="container" >        	
		            ...
		            <div class="spacer">
								...
								<!-- ID -->
		 		<input type="hidden" id="c_id2" value="' . $res['c_id'] . '" />	
												';
	...
	<div id="dialog-form">
		...
		<legend>დავალების ფორმირება</legend>
			    	...
			    	<table class="dialog-form-table">
						...
						<tr>
							<td colspan="6">
								<textarea  style="width: 747px; resize: none;" id="comment1" class="idle" name="comment" cols="300" rows="2"disabled="disabled">' . $res['comment1'] . '</textarea>
							</td>
						</tr>
						<tr>
						...
						<tr >
							<td colspan="6">
								<textarea  style="width: 747px; resize: none;" id="problem_comment" class="idle" name="comment" cols="300" rows="2">' . $res['problem_comment'] . '</textarea>
							</td>
						</tr>
					</table>
					</fieldset>
				...
				<table class="dialog-form-table">
						...
						<tr>
							<td><textarea  style="width: 740px; height:60px; resize: none;" id="question1_comment1" class="idle">'.$res['question1_comment'].'</textarea></td>
						</tr>
				</table>
				<hr>
				...
				<table class="dialog-form-table">
						...
						<tr>
							<td><textarea  style="width: 740px; height:60px; resize: none;" id="question2_comment1" class="idle">'.$res['question2_comment'].'</textarea></td>
						</tr>
				</table>
				</fieldset>
							</div>
