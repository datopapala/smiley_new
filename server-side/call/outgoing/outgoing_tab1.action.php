...
$num = 0;
	...
	<div id="dialog-form">
				...
				<fieldset >
			    	<legend style="'.$hide3.'">ძირითადი ინფორმაცია</legend>
					<fieldset  style="width:367px; float:left; '.$hide3.'" >
					...
					<fieldset style="width:354px; float:left; margin-left: 10px; '.$hide3.'">
				    	<table width="100%" class="dialog-form-table">
							<tr>
		...
		<input type="hidden" id="hhh_id" value="'.$res[nom_id].'"/> 
		</div>
    </div>';
	return $data;
